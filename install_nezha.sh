...
# 进入用户目录
cd ~/domains/musaka.serv00.net/public_html
...
cd ~/domains/musaka.serv00.net/public_html/nezha/cmd/dashboard
...
mkdir ~/domains/musaka.serv00.net/public_html/nezhapanel
cd ~/domains/musaka.serv00.net/public_html/nezhapanel

# 复制构建后的 dashboard 文件
echo "Copying dashboard binary..."
cp ~/domains/musaka.serv00.net/public_html/nezha/cmd/dashboard/dashboard ~/domains/musaka.serv00.net/public_html/nezhapanel/dashboard
...
rm ~/domains/musaka.serv00.net/public_html/nezhapanel/resource/resource.go

# 创建数据目录
echo "Creating data directory..."
mkdir ~/domains/musaka.serv00.net/public_html/nezhapanel/data
...
sed -i '' 's/language: .*/language: zh-CN/' ~/domains/musaka.serv00.net/public_html/nezhapanel/data/config.yaml
sed -i '' 's/httpport: .*/httpport: 7397/' ~/domains/musaka.serv00.net/public_html/nezhapanel/data/config.yaml
sed -i '' 's/grpcport: .*/grpcport: 18333/' ~/domains/musaka.serv00.net/public_html/nezhapanel/data/config.yaml
